...
public class ImageVision {
  ...
  /**
   ...
   - returns: a list of possible model objects and the prediction accuracy [ ("modelObject" , probability) ] (nil is return is case of trouble)
  ...
  /**
   ...
   - returns: a list of possible objects and the prediction accuracy [ ("object" , probability) ] (nil is return is case of trouble)
              This probability is expressed as percentage
   */
  ...
  /**
   ...
   - returns: a list of possible rooms type and the prediction accuracy [ ("place" , probability) ] (nil is return is case of trouble)
              This probability is expressed as percentage
   */
